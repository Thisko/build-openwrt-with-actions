...
# 编辑默认的luci显示的固件名称
sed -i 's/OpenWrt/OrangePiWRT/g' package/base-files/files/bin/config_generate
sed -i 's/ImmortalWrt/OrangePiWRT/g' package/base-files/files/bin/config_generate
