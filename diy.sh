...
# 编辑默认的luci显示的固件名称
sed -i 's/OpenWrt/Orange-WRT/g' package/base-files/files/bin/config_generate
sed -i 's/ImmortalWrt/Orange-WRT/g' package/base-files/files/bin/config_generate
